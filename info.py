...
# PyroClient Setup 
API_ID = int(environ['28192191'])
API_HASH = environ['663164abd732848a90e76e25cb9cf54a']
BOT_TOKEN = environ['7645408682:AAGvc1RTcI1w4gDPnavHae_oZvJpeiNHIv8']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1676244457').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '
-1002490466634').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://phnixsparrow:sabishnu@cluster0.lvdj9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
